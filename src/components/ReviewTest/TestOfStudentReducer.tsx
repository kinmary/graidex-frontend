...
import { IStudentAnswer } from "../../interfaces/StudentAnswers";
...
export const TestOfStudentReducer = (state: TestOfStudentState = initialState,
  action: Action) => {
